...
function addInputText(inputTextArray: string[], inputText: string): void {
  ...
  imageUrl = (pageIndex >= 0 && pageIndex < images.length ? images[pageIndex]?.src : imageUrl) ?? "";
  ...
  return {
    ...
    text: pageContent,
    buttons: buttons as [AllowedFrameButtonItems, AllowedFrameButtonItems, AllowedFrameButtonItems, AllowedFrameButtonItems],
